              ...
              <div className="flex-1 bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden sm:min-h-96">
                {!selectedCategory ? (
                  ...
                  <div className="flex flex-col sm:h-full">
                    ...
                    <div className="sm:flex-1 overflow-y-auto p-6">
                      {(() => {
                                        ...
                                        <div className="sm:hidden bg-white rounded-md p-3 space-y-1 shadow-sm w-full mb-2">
                                          ...
                                          <div className="flex items-center justify-between">
                                            <div className="flex items-center space-x-2 flex-1 min-w-0">
                                              ...
                                              <div className="text-sm font-medium text-gray-900 truncate font-sans flex-1">{transaction.description}</div>
                                            </div>
                                            <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium font-sans ${getStatusColor(transaction)}`}>
                                              {getStatusText(transaction)}
                                            </span>
                                          ...
                                          {/* Line 2: Year + Amount */}
                                          <div className="flex items-center justify-between">
                                            <div className="text-xs text-gray-500 font-sans">{months[transaction.month - 1]} {transaction.year}</div>
                                            <div className="text-sm font-medium text-gray-900 font-sans">{formatCurrency(transaction.value)}</div>
                                          </div>
                                        </div>
                                      </button>
